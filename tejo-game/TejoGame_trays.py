...
from game.ui_trays import UISystemTrays
...
class TejoGame(PUJ_Ogre.BaseApplicationWithVTK):
    ...
    def _loadScene(self):
        ...
        # Inicializar UI con TrayManager - solo pasar self (context)
        self.ui_system = UISystemTrays(self)
    ...
    def frameRenderingQueued(self, evt):
        ...
        # TrayManager no requiere llamadas adicionales por frame
